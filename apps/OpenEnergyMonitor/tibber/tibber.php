        ...
        <div class="row-fluid">
            <div class="span9 appconfig-description">
                <div class="appconfig-description-inner text-light">
                    <h2 class="appconfig-title text-primary"><?php echo _('Tibber'); ?></h2>
...
config.app = {
    ...
    "use_custom_feed":{"type":"select", "name":"Use custom price feed:", "default":"FALSE", "options":["TRUE", "FALSE"]},
    "custom_feed_id":{"optional":true, "type":"feed", "engine":5},
    "half_or_whole":{"type":"select", "name":"Is pricing a whole hour or half hour?", "default":"HALF_HOUR", "options":["HALF_HOUR", "FULL_HOUR"]},
...
function graph_load() 
{
    ...
    if (config.app.region!=undefined && regions_import[config.app.region.value]!=undefined) {
        data["agile"] = feed.getdata(195116,view.start,view.end,interval);
